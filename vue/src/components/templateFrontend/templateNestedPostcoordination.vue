      ...
      <v-col cols=12>
        <v-card>
          ...
          <v-card-text>
            ...
            Attributen <templateNestedGroup v-for="(group, key) in template.nestedTemplate.groups" :key="key" v-bind:groupData="group" v-bind:groupParents="groupKey+'/'+attributeKey+'/'+key" v-bind:groupKey="key" />
          </v-card-text>
        </v-card>
      </v-col>
    </v-row>
